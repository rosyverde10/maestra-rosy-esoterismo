...
export const AnnouncementBar: React.FC = () => {
  ...
  return (
    <div className="hidden sm:flex bg-gradient-to-r from-amber-950/90 via-purple-950/95 to-amber-950/90 text-amber-200 text-xs py-2 px-4 text-center font-medium shadow-md items-center justify-center gap-3 border-b border-amber-500/30 backdrop-blur-md relative overflow-hidden">
